...
// cara 1
let greatAuthors = [];
greatAuthors1 = books.filter((book) => book.sales > 1000000);
greatAuthors1 = greatAuthors1.map((greatAuthor) => {return `${greatAuthor.author} adalah penulis buku ${greatAuthor.title} yang sangat hebat!`});
console.log(greatAuthors);

// cara 2
const greatAuthors1 = books.filter((book) => book.sales > 1000000).map((greatAuthor) => {return `${greatAuthor.author} adalah penulis buku ${greatAuthor.title} yang sangat hebat!`});
console.log(greatAuthors1);